...
export default function AllBooks({ books, onFav }) {
  return (
          ...
          <div key={book.id} className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-xs lg:text-sm">
                ...
                <div onClick={()=>onFav(book.id)}>
                {
                  book.isFavorite ? (<button
                  ...
                  >
                    ...
                    Favourite
                  </button>) : ( <button className="flex min-w-[132px] items-center justify-center gap-1 rounded-md bg-[#1C4336]/[14%] py-1.5 text-[#1C4336] transition-all hover:bg-[#1C4336]/[24%] lg:py-1.5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
